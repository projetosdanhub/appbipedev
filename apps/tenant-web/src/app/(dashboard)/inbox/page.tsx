...
import { Search, Filter, MoreVertical, MessageCircle, Globe, Check, CheckCheck, Paperclip, Mic, Send, Phone, Video, Info, Tag, Clock, User, ChevronDown, Reply, Plus } from "lucide-react";
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="px-2.5 py-1 text-[12px] font-medium bg-red-100 dark:bg-red-500/20 text-red-600 dark:text-red-400 rounded-md border border-red-200 dark:border-red-500/30">
                  Urgente
                </span>
                <span className="px-2.5 py-1 text-[12px] font-medium bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 rounded-md border border-blue-200 dark:border-blue-500/30">
                  VIP
                </span>
                <span className="px-2.5 py-1 text-[12px] font-medium bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 rounded-md border border-amber-200 dark:border-amber-500/30">
                  Negociação
                </span>
                <button className="flex items-center justify-center w-[26px] h-[26px] bg-[#F1F5F9] dark:bg-[#1E293B] text-[#64748B] dark:text-[#94A3B8] rounded-md hover:bg-[#E2E8F0] dark:hover:bg-[#334155] transition-colors border border-[#E2E8F0] dark:border-[#334155]">
