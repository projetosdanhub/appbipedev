...
import { Button, Form, FormControl, FormField, FormItem } from "@bipesend/ui";
  ...
  return (
    <div className="auth-content-enter w-full space-y-4">
      ...
      <div className="p-4 bg-blue-50/50 text-[#0F172A] rounded-xl text-[14px] mb-8 flex gap-3 animate-fade-in border border-blue-100">
        ...
        <p>
          Se o e-mail existir no nosso sistema, um código seguro será enviado
      ...
      <div className="mt-8 text-center text-[14px] text-slate-500">
        ...
        {canResend ? (
          ...
          <span>
            Reenviar em{" "}
            <span className="font-semibold text-[#0F172A]">{countdown}s</span>
          </span>
        )}
      </div>
    </div>
